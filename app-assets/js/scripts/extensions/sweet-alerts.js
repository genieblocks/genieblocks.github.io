...
$(document).ready(function(){
	...
	$('#ota-job-delete-button').on('click',function(){
		swal({
		    title: "Are you sure?",
		    text: "You will not be able to recover this Archieved OTA Job!",
		    icon: "warning",
		    buttons: {
                cancel: {
                    text: "No, cancel plx!",
		...
		.then((isConfirm) => {
		    if (isConfirm) {
		        swal("Deleted!", "Your Archieved OTA Job has been deleted.", "success");
		    } else {
		        swal("Cancelled", "Your Archieved OTA Job is safe", "error");
		    }
		});

	});

	$('#table-delete-button').on('click',function(){
		swal({
		    title: "Are you sure?",
		...
		.then((isConfirm) => {
		    if (isConfirm) {
		        ...
		        swal("Cancelled", "Your table is safe", "error");
		    }
		});
